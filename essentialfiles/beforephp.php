...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//code to set $user and check if user has logged in 
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
$mysqli= require $_SERVER['DOCUMENT_ROOT'] .'/login/database.php';
...
if(isset($_COOKIE['session_id'])){
  ...
  if(!$user && $session_id && strpos($_SERVER['REQUEST_URI'], 'logout') == false){ //if user is not found in database while session id exists as cookie and the page isn't a logout process page.
