...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//if user hasn't logged in then redirect

if (!isset($_COOKIE['session_id']) && basename($_SERVER['SCRIPT_FILENAME']) !== 'asklogin.php' && basename($_SERVER['SCRIPT_FILENAME']) !== 'loading.php'){//if cookie is set then the user is logged in.. don't redirect if its the asklogin page itself, or the laoding.php page
	header('Location: ../asklogin.php');
	exit();
}
